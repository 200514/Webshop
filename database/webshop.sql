...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 22 apr 2021 om 13:00
...
admin_user_id`,
`email
`, `password`, `password_token`, `password_changed`, `datetime`) VALUES
...
(255) NOT NULL,
  `password` varchar
(255) NOT NULL,
  `newsletter_subscription` tinyint
(1) NOT NULL,
  `datetime` timestamp NOT NULL DEFAULT current_timestamp
()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
`last_name`,
`street
`, `house_number`, `house_number_addon`, `zip_code`, `city`, `phone`, `emailadres`, `password`, `newsletter_subscription`, 'datetime') VALUES
(1, 'male', 'Max', 'test', 'van Gend', 'Odenveltlaan', 34, 'a', '3451ZN', 'Utrecht', 0611514448, 'test@test.nl', '$2y$10$lhwtHbMjFQYIr/qFzq9aoOhwDnR/znGGH2KwhL8cy.7vm3SgnNEkW', 1);
...
INSERT INTO `order`
  (`order_id`, `customer_id`, `first_name`, `middle_name`, `last_name`, `street`, `house_number
`, `house_number_addon`, `zip_code`, `city`, `total_price`, `shipping_costs`, `payment_method`, `order_date`, `shipping_date`) VALUES
(1, 1, 'Max', 'van', 'Gend', 'Odenveltlaan', 34, 'A', '3451ZN', 'Utrecht', 15, 5, 'ING', '2021-04-22 00:00:00', '2021-04-30');
...
product_id`,
`name
`, `description`, `category_id`, `price`, `color`, `weight`, `active`) VALUES
...
--
ALTER TABLE `admin_user`
  MODIFY `admin_user_id` int
(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;

--
-- AUTO_INCREMENT voor een tabel `product_image`
--
ALTER TABLE `product_image`
  MODIFY `product_image_id` int
(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT voor een tabel `tbl_order`
--
ALTER TABLE `tbl_order`
  MODIFY `tbl_order_id` int
...
--
ALTER TABLE `tbl_order_detail`
  MODIFY `tbl_order_detail_id` int
(11) NOT NULL AUTO_INCREMENT;
COMMIT;
